...
function(initCppJsLib target source_dir include_dir)
    ...
    if (ENABLE_WEBSOCKET)
        ...
        if (NOT EXISTS ${WEBSOCKETPP})
            ...
            if (EXISTS ${GIT_PATH})
                ...
                execute_process(COMMAND "${GIT_EXISTS}" "clone" "https://github.com/zaphoyd/websocketpp" WORKING_DIRECTORY ${source_dir})
                file(COPY ${source_dir}/websocketpp/websocketpp DESTINATION ${include_dir})
            else()
    ...
    find_program (GIT_EXISTS git)

    message(STATUS "Git exists: ${GIT_OUTPUT}")
